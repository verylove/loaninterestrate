...
public class CheckVersion
{
    ...
    public class CheckVersionTask implements Runnable{
        ...
        public void run() {
            try {
                ...
                String path = "http://www.jblv.com/com.yt.loaninterestate/version.xml";
                //包装成url的对象
    ...
    private int getVersionCode(Context context)
    {
        ...
        try
        {
           ...
           versionCode = context.getPackageManager().getPackageInfo("com.yt.loaninterestate", 0).versionCode;
